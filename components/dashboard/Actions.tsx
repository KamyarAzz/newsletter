...
export default function Actions() {
  return (
    <div className="flex flex-col gap-4 shadow-sm-base dark:bg-darkFr rounded-md px-8 py-4 flex-auto">
      ...
      <button className="flex gap-2 justify-center items-center rounded-md w-full bg-blue-800 border dark:border-transparent hover:bg-blue-900 transition-colors duration-300 border-blue-800 text-white py-2 px-4 cursor-pointer">
